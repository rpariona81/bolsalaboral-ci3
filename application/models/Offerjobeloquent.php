...
class OfferJobEloquent extends Eloquent{
    ...
    public static function getOffersjob($id = NULL)
    {
        return OfferJobEloquent::leftjoin('t_careers', 't_offersjob.career_id','=','t_careers.id')
            ->select('t_offersjob.id','t_offersjob.title','t_offersjob.type_offer','t_offersjob.vacancy_numbers','t_offersjob.date_publish','t_offersjob.salary','t_offersjob.date_vigency','t_offersjob.status','t_offersjob.career_id','t_careers.career_title')
            ->first();
