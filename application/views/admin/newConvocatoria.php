<div class="align-items-md-stretch mt-5">
    <div class="card">
        ...
        <div class="card-body">
            <?= form_open('admin/creaConvocatoria', array('class' => 'row g-3 needs-validation')); ?>
            <div class="col-md-4">
            ...
            <div class="col-md-12">
                ...
                <textarea class="form-control" id="detail" name="detail" value="<?php echo set_value('detail') ?>"></textarea>
                <div class="valid-feedback">
                    Looks good!
                </div>
            </div>
            <div class="col-md-2">
                ...
                <input type="number" class="form-control" id="vacancy_numbers" name="vacancy_numbers" value="<?php echo set_value('vacancy_numbers') ?>">
            ...
            <div class="col-md-2">
                ...
                <input type="date" class="form-control" id="date_publish" name="date_publish" value="<?php echo set_value('date_publish') ?>">
                <div class="valid-feedback">
                    Looks good!
                </div>
            </div>
            <div class="col-md-2">
                ...
                <input type="date" class="form-control" id="date_vigency" name="date_vigency" value="<?php echo set_value('date_vigency') ?>">
                <div class="valid-feedback">
                    Looks good!
                </div>
            </div>
